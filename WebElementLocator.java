...
public class WebElementLocator extends ToolHelperFactory {
	...
	public WebElementLocator(String browser) {
		...
		if(browser.equalsIgnoreCase("Chrome")) {
    		...
    		System.setProperty("webdriver.chrome.driver",userDirectory+"/drivers/mac/chromedriver");
			...
			capabilities.setCapability("appPackage", "com.bookatable.android.debug");
			capabilities.setCapability("appActivity", "com.bookatable.android.uimodules.splash.SplashActivity");
			capabilities.setCapability("deviceName", "ce0117113206301b0c");
			try {
